...
Our goal is to predict earthquakes with location and time-based features.

*200 Years of Global Major Earthquakes (1826–2026)*
...
Create the environment once, then activate it when working on the project:
